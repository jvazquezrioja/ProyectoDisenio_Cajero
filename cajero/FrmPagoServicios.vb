Public Class FrmPagoservicio
    ...
    Private Sub btnLuz_Click(sender As Object, e As EventArgs) Handles btnLuz.Click
        setServicio(btnLuz.Text)
    End Sub

    Private Sub btnOtro_Click(sender As Object, e As EventArgs) Handles btnOtro.Click
        setServicio(btnOtro.Text)
    End Sub

    Private Sub btnAgua_Click(sender As Object, e As EventArgs) Handles btnAgua.Click
        setServicio(btnAgua.Text)
    End Sub

    Private Sub btnInternet_Click(sender As Object, e As EventArgs) Handles btnInternet.Click
        Servicio = btnInternet.Text 'Cambia el valor de Servicio directamente, sin irse a setServicio
        Me.Hide()
        FrmFrmCompañiasInt.Show() 'Muestra el form CompaniasInt para que el usuario seleccione una compaía antes de llegar al Form DatosPago
    End Sub

    Private Sub btnRegresar_Click(sender As Object, e As EventArgs) Handles btnRegresar.Click
        FrmFrmCompañiasInt.Dispose()
        Me.Close()
        FrmOpciones.Show()
    End Sub
